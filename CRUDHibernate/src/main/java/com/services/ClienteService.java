...
public class ClienteService {
	...
	//http://localhost:8090/CRUDHibernate/CRUDHibernate/cliente/mostrar
	@Path ("mostrar")
	@GET
	...
	@Produces ({MediaType.APPLICATION_JSON})
	public Status guardar (Cliente cl) {
		System.out.println("Cliente a guardar: "+cl);
		Status state= new Status();
		state.setOb(cl);
		
		dao = new ClienteDAO();
		String res = dao.guardar(cl);
	...
	@Consumes ({MediaType.APPLICATION_JSON})
	@Produces ({MediaType.APPLICATION_JSON})
	public Status editar (Cliente cl) {
		Status state= new Status();
		state.setOb(cl);
		
		dao = new ClienteDAO();
		String res = dao.editar(cl);
