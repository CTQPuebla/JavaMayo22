...
public class VentasService {
	...
	Ventas ventas = null; // Modelo de datos
	VentasDAO dao = null; // Objeto de acceso a datos
	...
	public Status guardar(Ventas c) {
		System.out.println("venta a guardar: "+c);
